...
// ─── 結果資料 ─────────────────────────────────────────────────
export const resultData: Record<BreakfastType, ResultData> = {
  薯餅蛋餅: {
    emoji: "🥔",
    name: "薯餅蛋餅",
    core: "先舒服，才能面對人生。",
    ...
    tags: ["#被床封印的人", "#低電量人格", "#慢熱系生物", "#拖延症晚期", "#舒服最重要"],
    pairing: "雞塊拼盤",
    pairingEmoji: "🍗",
  ...
  奶酥厚片: {
    ...
    tags: ["#高敏感人格", "#深夜emo系", "#腦內小劇場", "#戀愛腦候選人"],
    pairing: "鐵板麵",
    pairingEmoji: "🍝",
  ...
  鐵板麵: {
    ...
    tags: ["#deadline戰神", "#責任感過重", "#忙到忘記崩潰", "#高壓生存專家"],
    pairing: "奶酥厚片",
    pairingEmoji: "🍞",
  ...
  大冰奶: {
    ...
    tags: ["#精神狀態美麗", "#早餐店都市傳說", "#情緒與腸胃同步崩潰", "#活著全靠意志力"],
    pairing: "薯餅蛋餅",
    pairingEmoji: "🥔",
